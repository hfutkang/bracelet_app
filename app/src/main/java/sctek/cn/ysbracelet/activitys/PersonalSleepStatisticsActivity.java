...
public class PersonalSleepStatisticsActivity extends AppCompatActivity {
...
//        l.setTypeface(tf);
    ...
    private void initLineChart() {
        ...
        LimitLine limitLine = new LimitLine(8.f, "Goal");
...
//        initLineChart();
        ...
        ChartViewPagerAdapter adapter = new ChartViewPagerAdapter(this, 24, 1);
...
//        datas.add(new SportsData(getInt(random), random.nextInt(2000), "20160325201000"));
        ...
        BarDataSet runSet = new BarDataSet(runBars, "sleep");
...
//        datas.add(new SportsData(getInt(random), random.nextInt(2000), "20160325201000"));
        ...
        LineDataSet runSet = new LineDataSet(runBars, "sleep");
        runSet.setDrawValues(false);
