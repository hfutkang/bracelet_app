 ...
 */
public class FamilySportsMonthVpAdapter extends FamilyDataBaseVpAdapter {

    private final static String TAG = FamilySportsMonthVpAdapter.class.getSimpleName();

    public FamilySportsMonthVpAdapter(Context context) {
        super(context);
    }
    @Override
