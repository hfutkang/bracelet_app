 ...
 */
public class FamilyHRateDataMonthVpAdapter extends FamilyDataBaseVpAdapter {

    private final static String TAG = FamilyHRateDataMonthVpAdapter.class.getSimpleName();

    public FamilyHRateDataMonthVpAdapter(Context context) {
        super(context);
    }
    @Override
    ...
    protected BaseAdapter constructLvAdapter(Context context, View emptyV, int postion) {
        return new FamilyHRateMonthLvAdapter(context, emptyV, postion);
    }
}
