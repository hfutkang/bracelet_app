 ...
 */
public class FamilySportsWeekVpAdapter extends FamilyDataBaseVpAdapter {

    private final static String TAG = FamilySportsWeekVpAdapter.class.getSimpleName();

    public FamilySportsWeekVpAdapter(Context context) {
        super(context);
    }
    @Override
    ...
    protected BaseAdapter constructLvAdapter(Context context, View emptyV, int postion) {
        return new FamilySportsWeekLvAdapter(context, emptyV, postion);
    }
}
