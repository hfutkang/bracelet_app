 ...
 */
public class FamilySportsStatisticsWeekVpAdapter extends FamilyStatisticsBaseVpAdapter {

    private final static String TAG = FamilySportsStatisticsWeekVpAdapter.class.getSimpleName();

    public FamilySportsStatisticsWeekVpAdapter(Context context) {
        super(context);
    }
    @Override
    ...
    protected BaseAdapter constructLvAdapter(Context context, int postion) {
        return new FamilySportsStatisticsWeekLvAdapter(context, postion);
    }
}
