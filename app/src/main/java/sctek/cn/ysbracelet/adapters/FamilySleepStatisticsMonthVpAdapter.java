 ...
 */
public class FamilySleepStatisticsMonthVpAdapter extends FamilyStatisticsBaseVpAdapter {

    private final static String TAG = FamilySleepStatisticsMonthVpAdapter.class.getSimpleName();

    public FamilySleepStatisticsMonthVpAdapter(Context context) {
        super(context);
    }
    @Override
    ...
    protected BaseAdapter constructLvAdapter(Context context, int postion) {
        return new FamilySleepStatisticsMonthLvAdapter(context, postion);
    }
}
