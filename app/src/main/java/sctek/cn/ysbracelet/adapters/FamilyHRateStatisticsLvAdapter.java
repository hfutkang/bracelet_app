 ...
 */
public class FamilyHRateStatisticsLvAdapter extends BaseAdapter{

    private static final String TAG = FamilyHRateStatisticsLvAdapter.class.getSimpleName();
    ...
    private int[] colors = new int[]{Color.RED, Color.YELLOW, Color.BLUE, Color.GREEN, Color.CYAN};



    public FamilyHRateStatisticsLvAdapter(Context context, List<Object> m, int r, int l) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.hrate_statistics_item_view, null);

            viewHolder = new ViewHolder();
            viewHolder.name = (TextView)convertView.findViewById(R.id.name_tv);
            viewHolder.longest = (TextView)convertView.findViewById(R.id.hrate_highest_rate_tv);
            viewHolder.shortest = (TextView)convertView.findViewById(R.id.hrate_average_rate_tv);
            viewHolder.average = (TextView)convertView.findViewById(R.id.hrate_lowest_rate_tv);
