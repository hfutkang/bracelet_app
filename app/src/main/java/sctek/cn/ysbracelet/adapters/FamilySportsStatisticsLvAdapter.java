 ...
 */
public class FamilySportsStatisticsLvAdapter extends BaseAdapter{

    private static final String TAG = FamilySportsStatisticsLvAdapter.class.getSimpleName();
    ...
    private int[] colors = new int[]{Color.YELLOW, Color.BLUE, Color.RED, Color.GREEN, Color.CYAN};



    public FamilySportsStatisticsLvAdapter(Context context, List<Object> m, int r, int l) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.sports_statistics_item_view, null);

            viewHolder = new ViewHolder();
            viewHolder.name = (TextView)convertView.findViewById(R.id.name_tv);
            viewHolder.longest = (TextView)convertView.findViewById(R.id.sports_most_steps_tv);
            viewHolder.shortest = (TextView)convertView.findViewById(R.id.sports_least_steps_tv);
            viewHolder.average = (TextView)convertView.findViewById(R.id.sports_average_steps_tv);
